            ...
            <div>
                ...
                */}
                ...
                <div className="MonsterDecks--Timeline--ToggleContainer">
                    <h6
                        className="MonsterDecks--Timeline--Toggle"
                ...
                {showTimeline && (
                    <div className="MonsterDecks--Timeline">
                        {new Array(99).fill().map((_, i) => {
                            const initiative = i + 1;
                            const monsterInitiativeNames =
                                initiativeOrderMap[initiative];
                            const playerInitiativeNames =
                                playerInitiatives[initiative];
                            const hasMonsterInitiative =
                                monsterInitiativeNames &&
                                monsterInitiativeNames.length > 0;
                            const hasPlayerInitiative =
                                playerInitiativeNames &&
                                playerInitiativeNames.length > 0;
                            let content = [];
                            ...
                            return (
                                <div
                                    ...
                                    className={classNames({
                                        ...
                                        'MonsterDecks--Timeline--SelectedCell':
                                            this.state
                                                .initiativeSelectorIndex === i,
                                ...
                                >
                                    {this.state.initiativeSelectorIndex ===
                                        i && (
                                        <InitiativeSelector
